<template>
    <section class="faq overflow-hidden py-20 relative bg-gradient-to-r from-[#00001A] from-0% via-[#000066] via-26% to-[#000080] to-75%">
        <div class="max-w-[691px] vstext mx-auto my-auto flex flex-col gap-y-8">
            <p class="gradient-text text-[28px] mb-1 font-bold text-center">El futuro de la tecnología te está esperando. ¿Listo para dar el siguiente paso?</p>
